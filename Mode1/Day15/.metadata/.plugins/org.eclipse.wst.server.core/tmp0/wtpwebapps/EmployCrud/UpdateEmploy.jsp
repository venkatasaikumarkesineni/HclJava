...
<form method="get" action="UpdateEmploy.jsp"  >
  <center>
   ...
   <input type="text" name="name" value=<%=rs.getString("name")%> /><br/>
    Department:
    <input type="text" name="dept" value=<%=rs.getString("dept")%> /><br/>
    Designation:
    <input type="text" name="desig" value=<%=rs.getString("desig")%> /><br/>
    Basic:
    <input type="text" name="basic" value=<%=rs.getInt("basic")%> /><br/>
